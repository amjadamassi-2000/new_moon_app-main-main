...
class Products with ChangeNotifier {
  ...
  Future<void> gethometitle() async {
    const url =
        "https://moonapp-f63aa-default-rtdb.firebaseio.com/product.json";
    try {
      final http.Response res = await http.get(Uri.parse(url)).then((value) {
      ...
      await extractedData.forEach((prodId, prodData) {
        print(prodId);
        print(prodData);
      });
